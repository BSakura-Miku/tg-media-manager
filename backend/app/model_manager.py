...
MODEL_REGISTRY = {
    ...
    "faster-whisper-small": {
        ...
        "category": "speech",
        "kind": "runtime-cache",
        "description": "Fast speech-to-text model for previews and low-power machines.",
        "description_zh": "适合预览和低功耗机器的快速语音转文字模型。",
        "path": "whisper",
    ...
    "faster-whisper-medium": {
        ...
        "category": "speech",
        "kind": "runtime-cache",
        "description": "Balanced multilingual model used by the stable subtitle pipeline.",
        "description_zh": "稳定字幕链路使用的多语言均衡模型，质量明显高于 base。",
        "path": "whisper",
        "command": "faster-whisper",
        "model": "medium",
        "recommended": True,
    ...
    "funasr-nano-onnx": {
        "name": "Fun-ASR-Nano ONNX pack",
        "category": "speech",
        "kind": "archive",
        "description": "Optional lightweight ONNX subtitle engine for CPU-friendly batch transcription.",
        "description_zh": "可选轻量 ONNX 字幕转写模型包，适合 NAS CPU 批量转写。",
        "path": "funasr-nano/model.onnx",
        "archive_member": "",
        "official_url": "",
        "url_env": "FUNASR_NANO_ONNX_URL",
        "sha256_env": "FUNASR_NANO_ONNX_SHA256",
        "recommended": False,
    },
    ...
    "fastvit-t8-onnx": {
        ...
        "category": "vision",
        "kind": "file",
        "description": "Optional lightweight visual classifier for fast whole-library rescans.",
        "description_zh": "可选轻量画面分类模型，适合快速全库复扫。",
        "path": "vision/fastvit-t8.onnx",
        "official_url": "https://github.com/apple/ml-fastvit",
        "url_env": "FASTVIT_T8_ONNX_URL",
        "sha256_env": "FASTVIT_T8_ONNX_SHA256",
        "recommended": False,
    },
    "deeplabv3-onnx": {
        "name": "DeepLabV3 ONNX",
        "category": "vision",
        "kind": "file",
        "description": "Optional segmentation model for subject/background diagnostics.",
        "description_zh": "可选主体分割模型，用于人物主体和背景诊断。",
        "path": "vision/deeplabv3.onnx",
        "official_url": "https://pytorch.org/vision/main/models/deeplabv3.html",
        "url_env": "DEEPLABV3_ONNX_URL",
        "sha256_env": "DEEPLABV3_ONNX_SHA256",
        "recommended": False,
    },
    "vlm-lite": {
        "name": "Local VLM image understanding",
        "category": "vlm",
        "kind": "file",
        "description": "Optional vision-language model for selected/low-confidence frame understanding.",
        "description_zh": "可选本地 VLM，仅对低置信度、精选或手动触发素材做画面理解。",
        "path": "vlm/model.gguf",
        "official_url": "",
        "url_env": "VLM_MODEL_URL",
        "sha256_env": "VLM_MODEL_SHA256",
        "recommended": False,
    },
}
